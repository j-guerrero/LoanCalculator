...
namespace LoanLibrary
{
    public class LoanModel
    {
        ...
        public static decimal calculateMinimumPayment(LoanModel loan)
        {
            ...
            double periodicPayments = months * 12;
            decimal periodicInterestRate = interest / 12;
            double discountFactor = ((Math.Pow(((1 + (double)periodicInterestRate)), periodicPayments))-1) / Math.Pow(((double)periodicInterestRate * (1 + (double)periodicInterestRate)), periodicPayments);
